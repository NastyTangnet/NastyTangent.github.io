...
2. Copy the exported `coins.json` into the repo root (same folder as `index.html`).
...
GitHub Actions will update `spot.json` hourly (and append to `spot_history.json` for the chart).
